...
//     *
//     * @param array $ids Article ids, if provided
//     * @param null $limit
//     * @param null $offset
//     * @param null $columns Columns, null for default
//     * @return array Associative rows
//     */
//    public function getAvailableRows($ids = array(), $limit = null, $offset = null, $columns = null)
//    {
//        $result = $rows = array();
//
//        if (null === $columns) {
...
//     *
//     * @param $ids Article ids, if provided
//     * @return int Rows count
//     */
//    public function getAvailableRowsCount($ids = array())
//    {
//        $result = 0;
//
//        $select = $this->select()
